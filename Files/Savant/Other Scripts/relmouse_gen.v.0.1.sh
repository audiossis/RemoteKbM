		...
		<dict>
			...
			<dict>
				...
				<dict>
					...
					<string>Button [Pressed]</string>
					<key>RPMUICLayerPathKey</key>
					<string>Emersive iPad Retina AU Tank Test_2048x1536-18/Screens/RemoteKbM.psd.cache/TouchPad/Button [Pressed].png</string>
				</dict>" >> ./screen.plist
				((layerIndex++))
				echo -n "
				<key>Button [ToggleEnabled]</key>
				<dict>
					...
					<string>Button [Pressed]</string>
					<key>RPMUICLayerPathKey</key>
					<string>Emersive iPad Retina AU Tank Test_2048x1536-18/Screens/RemoteKbM.psd.cache/TouchPad/Button [ToggleEnabled].png</string>
				</dict>" >> ./screen.plist
				((layerIndex++))
				echo -n "
				<key>Button [TogglePressed]</key>
				<dict>
					...
					<string>Button [Pressed]</string>
					<key>RPMUICLayerPathKey</key>
					<string>Emersive iPad Retina AU Tank Test_2048x1536-18/Screens/RemoteKbM.psd.cache/TouchPad/Button [TogglePressed].png</string>
				</dict>" >> ./screen.plist
				((layerIndex++))
				echo -n "
			</dict>
