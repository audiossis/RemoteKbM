...
character_translate_table = {
    ...
    'tab' : 0x30,
    'space' : 0x31,
    'delete' : 0x33, # Also known as BackSpace
    'escape' : 0x35,
    'command' : 0x37,
    'shift' : 0x38,
    'capslock' : 0x39,
...
special_key_translate_table = {
    'KEYTYPE_SOUND_UP': 0, # F12
    'KEYTYPE_SOUND_DOWN': 1, # F11
    'KEYTYPE_BRIGHTNESS_UP': 2, # F2
    'KEYTYPE_BRIGHTNESS_DOWN': 3, # F1
    'KEYTYPE_CAPS_LOCK': 4,
    'KEYTYPE_HELP': 5,
    'POWER_KEY': 6,
    'KEYTYPE_MUTE': 7, # F10
    ...
    'KEYTYPE_PREVIOUS': 18,
    'KEYTYPE_FAST': 19, # F9
    'KEYTYPE_REWIND': 20, # F7
    'KEYTYPE_ILLUMINATION_UP': 21, # F6
    'KEYTYPE_ILLUMINATION_DOWN': 22, # F5
